package se.sowl.postHubingapi.oauth.factory;
...
import se.sowl.postHubingdomain.oauth.domain.OAuth2Profile;
import se.sowl.postHubingdomain.oauth.domain.OAuth2UserAttribute;
import se.sowl.postHubingdomain.oauth.domain.Role;
